...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(model, glm::vec3(-1.0f/2, -1.0f/2, 0.0f));
		...
		model = glm::translate(model, glm::vec3(0.0f, 1.0f / 2, 0.0f));
		//model = glm::translate(model, glm::vec3(-00.0f, 300.0f, 0.0f));
		shader.setMat4("model", glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 3);
